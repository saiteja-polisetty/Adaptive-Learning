...
<html>
    ...
    <body>
        ...
        <script>
            function myfunc()
            {
                location.href="editorialcalc1.php";
            }
          function myFunction() 
            {
                            //
                
                location.href="editorialcalc.php";
            }
      </script>
        <div class="container">
...
//                    echo $col;
//                    echo $id;
                    $sql2 = "UPDATE celearnt SET $id='$f' WHERE uid='$col';";
                    if ($conn->query($sql2) === TRUE) {
                                            //echo "Record updated successfully";
                    } else {
                        echo "Error updating record: " . $conn->error;
                    }
                    $sql = "SELECT eid,topicdata FROM editorial where eid='$id'";
