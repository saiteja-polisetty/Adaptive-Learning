    ...
    <body>
        <div class="container">
            <div class="rows" style="height: 10%">
                ...
                <div class="col-sm-2">
                    <a href="scoreboard.php"><button type="button" class="btn btn-warning " style="height: 100%;width: 100%;font-size: 20px">Submit
                                ...
                                while($row1 = $result1->fetch_assoc()) 
                                {
                                    ...
                                    if($row1["q".$q]==$s)
                                    {
                                        ...
                                        echo "<style>input[type='radio']{border: 0px;
                                            width: 5%;
                                            height: 1em;}</style>";
                                        echo "<form method='POST' action='quizconn.php'>";
