...
<html>
    ...
    <body>
        ...
        <script>
            function myfunc()
            {
                location.href="veditorialcalc1.php";
            }
          function myFunction() 
            {
                            
                
                location.href="veditorialcalc.php";
            }
      </script>
        <div class="container">
...
//                    echo $col;
//                    echo $id;
                    $sql2 = "UPDATE velearnt SET $id='$f' WHERE uid='$col';";
                    if ($conn->query($sql2) === TRUE) {
                                            //echo "Record updated successfully";
                    } else {
                        echo "Error updating record: " . $conn->error;
                    }
                    $sql = "SELECT vid,topicdata FROM veditoral where vid='$id'";
