<?php session_start(); 
    ...
    $n=$_SESSION['uname'];
    $c=$_SESSION['score'];
    //$sql="insert into scores values('$n',CURRENT_DATE,CURRENT_TIME,'$c','quant');";
    $sql="insert into scores (uid,dates,verbal) values ('$n',CURRENT_DATE,'$c');";
        ...
        <div class="container" style="background-color:azure">
            ...
            <div class="rows" style="height: 10%">
                ...
                <div class="col-sm-8">
                    ...
                    <!--center><h2><p>Fourth Aquired : <--?php echo $_SESSION['fourthlevel'] ?></p></h2></center>
                    <center><h2><p>Fifth Aquired : <--?php echo $_SESSION['fifthlevel'] ?> </p></h2></center><br-->
