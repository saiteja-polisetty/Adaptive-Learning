    ...
    <body>
        <div class="container">
            <div class="rows" style="height: 10%">
                ...
                <div class="col-sm-2">
                    <a href="scoreboard2.php"><button type="button" class="btn btn-warning " style="height: 100%;width: 100%;font-size: 20px">Submit
            ...
            <div class="rows" style="height: 90%;background-color: white;overflow:auto">
                ...
                if($_SESSION['no_of_ques']!=3)
                {
                   $_SESSION['no_of_ques']=$_SESSION['no_of_ques']+1;
                    ...
                    $l=$_SESSION['level'];
                    $name=$_SESSION['uname'];
                    $sql = "SELECT * FROM vquestions where level='$l';";
                    ...
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) 
                        {
                            ...
                            $sql1 = "SELECT * FROM vsolved1 where uid='$name';";
                            ...
                            if ($result1->num_rows > 0) 
                            {
                                while($row1 = $result1->fetch_assoc()) 
                                {
                                    ...
                                    if($row1["q".$q]==$s)
                                    {
                                        ...
                                        $f=1;
                                        $col="q".$q;
                                        $sql2 = "UPDATE vsolved1 SET $col='$f' WHERE uid='$name';";
                                        ...
                                        echo "<style>input[type='radio']{border: 0px;
                                            width: 5%;
                                            height: 1em;}</style>";
                                        echo "<form method='POST' action='vquizconn.php'>";
                ...
                {
                    header("location:scoreboard2.php");
                }
